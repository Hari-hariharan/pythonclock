...
def alarm():
        ...
        main_hour = str(int(main_hour1))
        main_hour = main_hour1
        if int(alarm_hour) == int(main_hour) and int(alarm_minutes) == int(main_minutes):
                for i in range(3):
...
remainder_instructions_label = Label(remainder_tab, font = 'calibri 10 bold', text = "Enter Remainder Time. Eg -> 01:30 , 01 -> Hour, 30 -> Minutes")
remainder_instructions_label.pack(anchor='s')
